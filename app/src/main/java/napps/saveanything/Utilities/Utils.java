...
public class Utils {
    ...
    public static String getUniqueId(Context context, String prefix, long timeStamp){
        ...
        //System.currentmillis is a JNI call, so we shouldn't call it multiple times and moreover our id and imageId should be in sync
        return prefix + getUniqueDeviceId(context)+(timeStamp - getAppInstallTime(context));
    }
